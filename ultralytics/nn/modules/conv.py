...
"""Convolution modules for medical imaging applications."""
...
# Remove CBAM and CoordAtt from __all__ since they're now in separate files
__all__ = (
    "Conv",
    "Conv2",
    "LightConv",
...
def autopad(k, p=None, d=1):
    """Pad to 'same' shape outputs with dilation support."""
    if d > 1:
...
class Conv(nn.Module):
    """Medical-optimized convolution with batch normalization and SiLU activation."""
    default_act = nn.SiLU()
